        ...
        <section id="Login" class="Container">
            ...
            <article>
                <form action="Login" method="post">
                    <input type="text" placeholder="Username" name="username" class="Input" style="width: 340px;" required/><br />
                    <input type="password" placeholder="Password" name="password" class="Input" style="width: 340px; margin-top: 15px;" required/><br />
